...
?>
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="radio" name="cat_top" value="no" checked>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_cat = "insert into categories (cat_title,cat_top,cat_image,p_cat_id) values ('$cat_title','$cat_top','$cat_image','$p_cat_id')";
